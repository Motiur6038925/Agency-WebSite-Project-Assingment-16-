    ...
    <div>
      <section className=" py-[200px]">
        <div className=" flex justify-center items-center   ">
          <div className=" container mx-auto  flex flex-col items-start gap-[40px]">
            <div className=" flex  flex-col mb-[40px]  mt-[7px] items-start gap-[15px]">
              {/* color: #000; font-family: Poppins; font-size: 30px; font-style:
            normal; font-weight: 600; line-height: normal; */}
              <p className=" text-[#20B15A] text-[20px] font-medium uppercase leading-normal">
                {data[0].title}
              </p>
              <p className=" text-[#000] text-[30px]  font-bold leading-normal">
                {data[0].des}
              </p>
            </div>
            ...
            <div className="  grid  grid-cols-3 gap-6  ">
              {/* //1 */}
              <div className=" flex flex-col items-start gap-[43px] w-[380px ] h-[415px] pt-[50px] pb-[30px] px-10 rounded-2xl shadow-lg ">
                <div className=" flex  flex-col items-start gap-[15px]">
                  ...
                  <div className="  w-[380px]   ">
                    <h2 className=" text-[24px] font-semibold leading-normal not-italic">
                      Grow Your Business
                    </h2>
                    <p>
                      We help identify the best ways <br /> to improve your
                      business
                    </p>

                    <p className=" flex items-center  rounded[30px] gap-2 ">
                      Learn More{" "}
                      <span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
