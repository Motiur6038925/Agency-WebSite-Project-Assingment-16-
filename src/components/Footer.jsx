...
const Footer = () => {
  return (
    <section>
      <div className=" bg-gray-900 radius-for-skewed  py-[40px]">
        <div className="container mx-auto px-4">
          <div className=" grid grid-cols-3 gap-4">
            <div>
              <div className="  pb-12  ">
                <div className="    w-full  mb-12 lg:mb-4">
                  <h1
                    className=" text-[#FFF]  text-[39.2px] font-bold "
                    href="#"
                  >
                    WEB LOGO
                  </h1>
                ...
                <div className="mt-8 ">
                  <p className="order-last text-sm  font-normal text-[#FFF]">
                ...
                <div className=" my-4 ">
                  <a
                    className="inline-block      p-2 bg-gray-800 hover:bg-gray-700 rounded"
                    href="#"
                  >
                    <svg
                ...
                <p className=" mt-14  text-sm text-[#FFF] ">
            ...
            <div>
              ...
              <div className="pb-12   ">
                <a
                  className=" text-[#FFF]   text-[20px] font-semibold leading-none"
                  href="#"
                >
                  Quick Links
                </a>
...
gap: 25px; */}
                ...
                <div className="mt-8  flex  flex-col items-start gap-[25px] ">
                  <p className="order-last text-sm text-[#FFF]">Services</p>

                  <p className=" text-[#FFF]">contact us</p>

                  <p className="order-last text-sm text-[#FFF]">about us</p>
                  <p className="order-last text-sm text-[#FFF]">Protfolio</p>
                </div>
              </div>
            </div>
            <div>
...
gap: 25px; */}
                ...
                <div className="mt-8  gap-[25px] ">
                  <p className="order-last text-sm text-[#FFF]">
                    Design Agency Head Office.
                  </p>
                  <p className="order-last text-sm text-[#FFF]">Airport Road</p>
                  <p className="order-last text-sm text-[#FFF]">
                    United Arab Emirate
                  </p>
                </div>
